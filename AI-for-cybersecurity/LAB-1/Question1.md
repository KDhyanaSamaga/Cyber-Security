...
1. **Find and print the average (mean) temperature for the week.**
2. **Identify and print the maximum and minimum temperatures and their respective days.**
3. **Display the temperatures greater than a specific value.**
...
1. **Create a new column with total marks**
2. **Find the lowest marks in Marks1**
3. **Find the Highest marks in Marks2**
4. **Find the average marks in Marks3**
5. **Find student name with highest average**
6. **Find how many students failed in Marks2 (<40)**
---
